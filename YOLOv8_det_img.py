...
class YOLOv8:
    ...
    def postprocess(self, input_image, output):
        ...
        print("np.squeeze(output[0]):", np.squeeze(output[0]).shape)

        # np.squeeze(output[0]): (84, 8400)
        # np.transpose  (8400, 84)

        print("outputs = np.transpose(np.squeeze(output[0])):", outputs.shape)
